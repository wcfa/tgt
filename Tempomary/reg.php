...
<div class="row">
<div class="col-lg-6 col-sm-6"><br><p>Welcome join Together.<br><br>You will find something <br>you like in here.</p></div>
...
<div class="input-group">
<h3>Your Real Name</h3>
<input type="text" name="username" value="" class="form-control" placeholder="wu chi fung"/>
</div>
